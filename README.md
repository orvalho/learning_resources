...
- [x] [CSS Beginner Tutorial *by HTML Dog*.](http://www.htmldog.com/guides/css/beginner/)
...
- [x] [Intro to HTML/CSS: Making webpages *by Khan Academy*.](https://www.khanacademy.org/computing/computer-programming/html-css)
